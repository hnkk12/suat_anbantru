...
function ImageCard({ group, images, onChoose, onPreview, onRemove }) {
  ...
  return <article className="flex min-h-[152px] flex-col rounded-2xl border border-[#d9dad5] bg-white p-4 shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-md">
